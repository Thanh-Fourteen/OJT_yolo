...
from utils.torch_utils import (fuse_conv_and_bn, fuse_deconv_and_bn, initialize_weights, model_info, model_info_deyo, profile, scale_img, select_device,
                               time_sync)
from utils.tal.anchor_generator import make_anchors, dist2bbox

from models.utils import bias_init_with_prob, linear_init
from torch.nn.init import constant_, xavier_uniform_
from models.transformer import MLP, DeformableTransformerDecoder, DeformableTransformerDecoderLayer
try:
...
class RTDETRDecoder(Detect):
    ...
    def __init__(
        ...
        self.detect = DualDetect.forward
        self.hidden_dim = hd
        self.nhead = nh
