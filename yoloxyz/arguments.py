...
def training_arguments(known=False):
    ...
    # parser.add_argument('--cfg', type=str, default='D:/FPT/AI/Major6/OJT_yolo/yoloxyz/cfg/architecture/yolov9-s-rtdetr.yaml', help='model.yaml path')
    parser.add_argument('--cfg', type=str, default='D:/FPT/AI/Major6/OJT_yolo/yoloxyz/cfg/architecture/yolov9-c.yaml', help='model.yaml path')
