...
def training_arguments(known=False):
    ...
    parser.add_argument('--project-wandb', type=str, default="Test", help='name project in wandb')
    ...
    # Deyo transforms
    parser.add_argument('--mosaic', type=float, default=1.0, help='Probability of applying mosaic augmentation (0 to disable, 1 for always).')
    parser.add_argument('--mixup', type=float, default=0.0, help='Probability of applying mixup augmentation (0 to disable, 1 for always).')
    parser.add_argument('--copy_paste', type=float, default=0.0, help='Probability of applying copy-paste augmentation (0 to disable, 1 for always).')
    parser.add_argument('--degrees', type=float, default=0.0, help='Maximum rotation degrees for augmentation.')
    parser.add_argument('--translate', type=float, default=0.1, help='Maximum translation fraction for augmentation (0 to disable).')
    parser.add_argument('--scale', type=float, default=0.5, help='Scale factor range for augmentation (e.g., 0.5 allows scaling from 0.5x to 1.5x).')
    parser.add_argument('--shear', type=float, default=0.0, help='Maximum shear angle (in degrees) for augmentation.')
    parser.add_argument('--perspective', type=float, default=0.0, help='Perspective distortion coefficient for augmentation (0 to disable).')
    parser.add_argument('--fliplr', type=float, default=0.5, help='Probability of flipping the image horizontally.')
    parser.add_argument('--flipud', type=float, default=0.0, help='Probability of flipping the image vertically.')
    parser.add_argument('--hsv_s', type=float, default=0.7, help='Saturation adjustment factor for HSV augmentation.')
    ...
    parser.add_argument('--show', type=bool, default=False, help='Show predicted images and videos if the environment allows (True to enable, False to disable).')
    parser.add_argument('--line_width', type=int, default=None, help='Line width of the bounding boxes. Scaled to image size if None.')
    parser.add_argument('--show_labels', type=bool, default=True, help='Show prediction labels, e.g., "person" (True to enable, False to disable).')
    parser.add_argument('--show_conf', type=bool, default=True, help='Show prediction confidence, e.g., "0.99" (True to enable, False to disable).')
    parser.add_argument('--show_boxes', type=bool, default=True, help='Show prediction bounding boxes (True to enable, False to disable).')
    parser.add_argument('--retina_masks', type=bool, default=False, help='Use high-resolution segmentation masks (True to enable, False to disable).')
    parser.add_argument('--save_crop', type=bool, default=False, help='Save cropped images with results (True to enable, False to disable).')
